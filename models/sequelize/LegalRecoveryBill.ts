...
LegalRecoveryBill.init({
  ...
  collectionStatus: { type: DataTypes.STRING, allowNull: true },
  collectionRemark: { type: DataTypes.TEXT, allowNull: true },
  collectionUpdatedById: { type: DataTypes.STRING, allowNull: true },
  collectionUpdatedByName: { type: DataTypes.STRING, allowNull: true },
  collectionUpdatedAt: { type: DataTypes.DATE, allowNull: true },
