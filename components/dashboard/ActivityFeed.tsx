    ...
    return (
      <div className="space-y-6">
        {activities.map((activity, idx) => {
          ...
          return (
            <div key={activity.id} className="relative flex justify-between gap-4 py-1">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className={`text-xs font-black tracking-wider uppercase ${dark ? "text-gray-200" : "text-slate-800"}`}>
                    {activity.title}
                  </h4>
                  <p className={`text-xs mt-0.5 leading-relaxed ${dark ? "text-gray-400" : "text-slate-500"}`}>
                    {activity.description}
                  </p>
                  <span className={`text-[10px] font-medium mt-1 block ${dark ? "text-gray-550" : "text-slate-400"}`}>
